...
public class CliFrontendParser {
	...
	static final Option CLASSPATH_OPTION = new Option("C", "classpath", true, "Adds a URL to each user code classloader " +
			"on all nodes in the cluster. The paths must specify a protocol (e.g. file://) and be accessible " +
					"on all nodes (e.g. by means of a NFS share). You can use this option multiple times for " +
					"specifying more than one URL.");
