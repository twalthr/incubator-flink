...
public class HiveCatalog extends AbstractCatalog {
    ...
    private CatalogBaseTable instantiateCatalogTable(Table hiveTable, HiveConf hiveConf) {
        ...
        if (isGeneric) {
            ...
            properties.put(IS_GENERIC, String.valueOf(false));
            // Table schema
    ...
    public void createPartition(
        ...
        boolean isGeneric = Boolean.parseBoolean(partition.getProperties().get(IS_GENERIC));
    ...
    public static boolean isGenericForCreate(Map<String, String> properties) {
        ...
        boolean isGeneric;
        if (!properties.containsKey(IS_GENERIC)) {
            // must be a generic object
            isGeneric = true;
            properties.put(IS_GENERIC, String.valueOf(true));
        } else {
            isGeneric = Boolean.parseBoolean(properties.get(IS_GENERIC));
        }
        return isGeneric;
    }
    ...
    public static boolean isGenericForGet(Map<String, String> properties) {
        ...
        return properties != null
                && Boolean.parseBoolean(properties.getOrDefault(IS_GENERIC, "false"));
    }
