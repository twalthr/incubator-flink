 ...
 * for encoding a change in a changelog. Thus, a row can be considered as an entry in changelog. For example,
...
public final class Row implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return kind.equals(row.kind) && Arrays.deepEquals(fields, row.fields);
	}

	@Override
	public int hashCode() {
		return 31 * kind.hashCode() + Arrays.deepHashCode(fields);
	}
