 ...
 *
 * <p>Since comparators are used only in DataSet API for batch use cases, this comparator ignores
 * {@link Row#getKind()} for simplicity of the implementation and efficiency.
 */
@Internal
