...
package com.dataartisans.flinktraining.exercises.table_java.sources;
...
public class TaxiRideTableSource implements StreamTableSource<Row>, DefinedRowtimeAttribute {
	...
	public TaxiRideTableSource(Properties properties) {
		this.taxiRideSource = new TaxiRideSource(
				properties.getProperty("dataFilePath"),
				Integer.parseInt(properties.getProperty("maxEventDelaySecs")),
				Integer.parseInt(properties.getProperty("servingSpeedFactor")));
	}
