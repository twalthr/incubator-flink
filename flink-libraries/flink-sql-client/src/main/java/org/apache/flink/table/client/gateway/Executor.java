...
public interface Executor {
	...
	/**
	 * Asks for the next result (non-blocking). Returns null if no new result is available.
	 */
	TypedResult<Tuple2<Boolean, Row>> retrieveResultRecord(SessionContext context, String resultId) throws SqlExecutionException;
