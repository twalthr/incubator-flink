...
class DataSetAggregate(
  ...
  override def toString: String = {
    s"Aggregate(${ if (!grouping.isEmpty) {
      ...
      ""
    }}select:(${aggregationToString(inputType, grouping, rowType, namedAggregates)}))"
  }

  override def explainTerms(pw: RelWriter): RelWriter = {
    super.explainTerms(pw)
      .itemIf("groupBy", groupingToString(inputType, grouping), !grouping.isEmpty)
      .item("select", aggregationToString(inputType, grouping, rowType, namedAggregates))
  }
  ...
  override def translateToPlan(
    ...
    val aggString = aggregationToString(inputType, grouping, rowType, namedAggregates)
