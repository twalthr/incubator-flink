...
/**
  ...
  * ([[TableSource.getTableSchema]] (or [[TableSink.getTableSchema]]) to fields of the physical
  * returned type [[TableSource.getReturnType]] (or [[TableSink.getOutputType]]).
  *
  * If a [[TableSource]] or [[TableSink]] does not implement the [[DefinedFieldMapping]] interface,
  * the fields of its [[TableSchema]] are mapped to the fields of its return type
  * [[TypeInformation]] by name.
  *
...
trait DefinedFieldMapping {
  ...
  /**
    * Returns the mapping for the fields of the [[TableSource]]'s or [[TableSink]]'s [[TableSchema]]
    * to the fields of its return/output type [[TypeInformation]].
    *
    ...
    * @deprecated Use [[getNestedFieldMapping]] instead.
    */
  @Deprecated
  @deprecated
  @Nullable
  ...
  /**
    ...
    * fields in the physical [[TypeInformation]] accessible for a [[TimestampExtractor]].
    *
    * Compared to its deprecated alternative [[getFieldMapping]], this method will allow for
    * nested field mappings in future versions. However, this is not supported yet.
    *
    * @return A mapping from [[TableSchema]] fields to [[TypeInformation]] fields if a
    *         mapping is necessary.
    */
  def getNestedFieldMapping: Optional[JMap[Array[String], Array[String]]] =
    TableConnectorUtil.generateNestedFieldMapping(getFieldMapping)
}
