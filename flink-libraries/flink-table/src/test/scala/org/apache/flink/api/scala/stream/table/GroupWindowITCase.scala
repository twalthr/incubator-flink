...
class GroupWindowITCase extends StreamingMultipleProgramsTestBase {
  ...
  def testWindowStartEnd(): Unit = {
    ...
    val windowedTable = table
      ...
      .select('string, 'int.count, 'w.start)
    ...
    val expected = Seq(
      "Hello world,1,1970-01-01 00:00:00.005", "Hello world,1,1970-01-01 00:00:00.015",
      "Hello,2,1970-01-01 00:00:00.0", "Hi,1,1970-01-01 00:00:00.0")
    assertEquals(expected.sorted, StreamITCase.testResults.sorted)
  }
}
