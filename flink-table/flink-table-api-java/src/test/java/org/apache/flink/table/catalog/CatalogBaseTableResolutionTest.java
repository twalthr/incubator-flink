...
public class CatalogBaseTableResolutionTest {
    ...
    @Test
    public void testCatalogTableResolution() throws TableNotExistException {
        ...
        final ResolvedCatalogTable resolvedTable =
                resolve(ResolvedCatalogTable.class, catalogManager, table);
    ...
    @Test
    public void testCatalogViewResolution() throws TableNotExistException {
        final CatalogManager catalogManager = catalogManager();
        final CatalogView view = catalogView();

        final ResolvedCatalogView resolvedView =
                resolve(ResolvedCatalogView.class, catalogManager, view);

        assertThat(resolvedView.getResolvedSchema(), equalTo(RESOLVED_VIEW_SCHEMA));
    }

    @Test
    public void testPropertyDeSerialization() throws TableNotExistException {
        final CatalogManager catalogManager = catalogManager();
    ...
    private static <T extends CatalogBaseTable> T resolve(
            Class<T> expectedClass, CatalogManager catalogManager, CatalogBaseTable table)
        ...
        final CatalogBaseTable storedTable = catalog.getTable(IDENTIFIER.toObjectPath());
