...
final class DataTypeFactoryImpl implements DataTypeFactory {
	...
	private DataTypeFactoryImpl(
			...
			Supplier<ExecutionConfig> executionConfig) {
		this.classLoader = classLoader;
		this.executionConfig = executionConfig;
	}

	/**
	 * Creates a {@link DataTypeFactory} with information from {@link ExecutionConfig} (if available)
	 * enriched with table {@link ReadableConfig}.
	 */
	DataTypeFactoryImpl(
			ClassLoader classLoader,
