...
public final class TimeType extends LogicalType {
	...
	private final static int DEFAULT_PRECISION = 0;

	private final static String DEFAULT_FORMAT = "TIME(%d)";
	...
	private final static Class<?> DEFAULT_CONVERSION = java.time.LocalTime.class;
