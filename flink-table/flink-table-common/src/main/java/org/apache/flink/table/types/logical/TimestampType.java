...
public final class TimestampType extends LogicalType {
	...
	private final static String DEFAULT_FORMAT = "TIMESTAMP(%d)";

	private final static Set<String> INPUT_OUTPUT_CONVERSION = conversionSet(
		java.sql.Timestamp.class.getName(),
		java.time.LocalDateTime.class.getName());

	private final static Class<?> DEFAULT_CONVERSION = java.time.LocalDateTime.class;
	 ...
	 */
	@Internal
	public TimestampType(boolean isNullable, Kind kind, int precision) {
