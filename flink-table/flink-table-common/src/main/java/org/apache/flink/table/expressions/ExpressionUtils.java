...
public final class ExpressionUtils {
	 ...
	 * @param functionKind expected type of function
	 * @return true if the expression is function call of given type, false otherwise
	 */
	public static boolean isFunctionOfType(Expression expr, FunctionDefinition.FunctionKind functionKind) {
		return expr instanceof CallExpression &&
			((CallExpression) expr).getFunctionDefinition().getKind() == functionKind;
	}
