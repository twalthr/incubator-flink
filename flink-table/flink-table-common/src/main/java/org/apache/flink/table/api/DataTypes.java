...
public final class DataTypes {
	...
	public static abstract class AbstractField {
		...
		private AbstractField(String name, AbstractDataType<?> dataType, @Nullable String description) {
			this.name = name;
	...
	public static final class UnresolvedField extends AbstractField {
		...
		/**
		 * Converts this instance to a resolved {@link Field}.
		 */
		public Field toField(DataTypeFactory factory) {
			return new Field(name, factory.createDataType(dataType), description);
		}
	}
