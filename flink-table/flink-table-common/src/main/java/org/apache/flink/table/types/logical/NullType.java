...
public final class NullType extends LogicalType {
	...
	private final static String DEFAULT_FORMAT = "NULL";

	private final static Class<?> INPUT_CONVERSION = Object.class;

	private final static Class<?> DEFAULT_CONVERSION = Object.class;
