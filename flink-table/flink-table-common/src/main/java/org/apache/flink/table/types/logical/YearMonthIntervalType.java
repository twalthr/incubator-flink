...
public final class YearMonthIntervalType extends LogicalType {
	...
	private final static int MAX_PRECISION = 4;

	private final static int DEFAULT_PRECISION = 2;

	private final static String DEFAULT_YEAR_FORMAT = "INTERVAL YEAR(%d)";

	private final static String DEFAULT_YEAR_TO_MONTH_FORMAT = "INTERVAL YEAR(%d) TO MONTH";

	private final static String DEFAULT_MONTH_FORMAT = "INTERVAL MONTH";
	...
	private final static Class<?> DEFAULT_CONVERSION = java.time.Period.class;
