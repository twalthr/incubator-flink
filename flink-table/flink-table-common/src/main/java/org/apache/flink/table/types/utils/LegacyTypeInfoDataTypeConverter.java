 ...
 * Flink 1.9. The conversion is a 1:1 mapping that allows back-and-forth conversion. It includes:
 *
...
public final class LegacyTypeInfoDataTypeConverter {
	...
	static {
		...
		addMapping(Types.SQL_TIME, DataTypes.TIME(3).bridgedTo(java.sql.Time.class));
