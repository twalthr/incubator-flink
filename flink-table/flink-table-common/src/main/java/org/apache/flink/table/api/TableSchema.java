...
import static org.apache.flink.table.types.utils.TypeInfoDataTypeConverter.toTypeInfo;
...
public class TableSchema {
	...
	public TableSchema(String[] fieldNames, TypeInformation<?>[] fieldTypes) {
		this(fieldNames, TypeInfoDataTypeConverter.toDataType(fieldTypes));
	}
	...
	public TypeInformation<?>[] getFieldTypes() {
		return toTypeInfo(fieldDataTypes);
	}
	...
	public Optional<TypeInformation<?>> getFieldType(int fieldIndex) {
		return getFieldDataType(fieldIndex).map(TypeInfoDataTypeConverter::toTypeInfo);
	}
	...
	public Optional<TypeInformation<?>> getFieldType(String fieldName) {
		return getFieldDataType(fieldName).map(TypeInfoDataTypeConverter::toTypeInfo);
	}
	...
	public TypeInformation<Row> toRowType() {
		return (TypeInformation<Row>) toTypeInfo(toRowDataType());
	}
	...
	public static class Builder {
		...
		public Builder field(String name, TypeInformation<?> typeInfo) {
			return field(name, toDataType(typeInfo));
		}
