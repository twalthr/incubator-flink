...
public final class DecimalType extends LogicalType {
	...
	private final static int DEFAULT_SCALE = 0;

	private final static String DEFAULT_FORMAT = "DECIMAL(%d, %d)";

	private final static Set<String> INPUT_OUTPUT_CONVERSION = conversionSet(
		BigDecimal.class.getName(),
		"org.apache.flink.table.dataformat.Decimal");

	private final static Class<?> DEFAULT_CONVERSION = BigDecimal.class;
