...
public final class LocalZonedTimestampType extends LogicalType {
	...
	private final static String DEFAULT_FORMAT = "TIMESTAMP(%d) WITH LOCAL TIME ZONE";
	...
	private final static Class<?> DEFAULT_CONVERSION = java.time.Instant.class;
	 ...
	 */
	@Internal
	public LocalZonedTimestampType(boolean isNullable, Kind kind, int precision) {
