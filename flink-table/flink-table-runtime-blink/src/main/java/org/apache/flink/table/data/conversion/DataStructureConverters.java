...
public final class DataStructureConverters {
	...
	static {
		...
		putConverter(LogicalTypeRoot.CHAR, String.class, singleton(StringStringConverter::new));
		putConverter(LogicalTypeRoot.CHAR, byte[].class, singleton(StringByteArrayConverter::new));
		putConverter(LogicalTypeRoot.CHAR, StringData.class, identity());
		putConverter(LogicalTypeRoot.VARCHAR, String.class, singleton(StringStringConverter::new));
		putConverter(LogicalTypeRoot.VARCHAR, byte[].class, singleton(StringByteArrayConverter::new));
		...
		putConverter(LogicalTypeRoot.DOUBLE, double.class, identity());
		putConverter(LogicalTypeRoot.DATE, java.sql.Date.class, singleton(DateDateConverter::new));
		putConverter(LogicalTypeRoot.DATE, java.time.LocalDate.class, singleton(DateLocalDateConverter::new));
		putConverter(LogicalTypeRoot.DATE, Integer.class, identity());
		putConverter(LogicalTypeRoot.DATE, int.class, identity());
		putConverter(LogicalTypeRoot.TIME_WITHOUT_TIME_ZONE, java.sql.Time.class, singleton(TimeTimeConverter::new));
		putConverter(LogicalTypeRoot.TIME_WITHOUT_TIME_ZONE, java.time.LocalTime.class, singleton(TimeLocalTimeConverter::new));
		...
		putConverter(LogicalTypeRoot.TIME_WITHOUT_TIME_ZONE, Long.class, singleton(TimeLongConverter::new));
		putConverter(LogicalTypeRoot.TIME_WITHOUT_TIME_ZONE, long.class, singleton(TimeLongConverter::new));
		putConverter(LogicalTypeRoot.TIMESTAMP_WITHOUT_TIME_ZONE, java.sql.Timestamp.class, singleton(TimestampTimestampConverter::new));
		putConverter(LogicalTypeRoot.TIMESTAMP_WITHOUT_TIME_ZONE, java.time.LocalDateTime.class, singleton(TimestampLocalDateTimeConverter::new));
		...
		putConverter(LogicalTypeRoot.TIMESTAMP_WITH_LOCAL_TIME_ZONE, java.time.Instant.class, singleton(LocalZonedTimestampInstantConverter::new));
		putConverter(LogicalTypeRoot.TIMESTAMP_WITH_LOCAL_TIME_ZONE, Integer.class, singleton(LocalZonedTimestampIntConverter::new));
		putConverter(LogicalTypeRoot.TIMESTAMP_WITH_LOCAL_TIME_ZONE, int.class, singleton(LocalZonedTimestampIntConverter::new));
		putConverter(LogicalTypeRoot.TIMESTAMP_WITH_LOCAL_TIME_ZONE, Long.class, singleton(LocalZonedTimestampLongConverter::new));
		putConverter(LogicalTypeRoot.TIMESTAMP_WITH_LOCAL_TIME_ZONE, long.class, singleton(LocalZonedTimestampLongConverter::new));
		...
		putConverter(LogicalTypeRoot.INTERVAL_DAY_TIME, java.time.Duration.class, singleton(DayTimeIntervalDurationConverter::new));
		...
		putConverter(LogicalTypeRoot.ARRAY, boolean[].class, singleton(ArrayBooleanArrayConverter::new));
		putConverter(LogicalTypeRoot.ARRAY, byte[].class, singleton(ArrayByteArrayConverter::new));
		putConverter(LogicalTypeRoot.ARRAY, short[].class, singleton(ArrayShortArrayConverter::new));
		putConverter(LogicalTypeRoot.ARRAY, int[].class, singleton(ArrayIntArrayConverter::new));
		putConverter(LogicalTypeRoot.ARRAY, long[].class, singleton(ArrayLongArrayConverter::new));
		putConverter(LogicalTypeRoot.ARRAY, float[].class, singleton(ArrayFloatArrayConverter::new));
		putConverter(LogicalTypeRoot.ARRAY, double[].class, singleton(ArrayDoubleArrayConverter::new));
	...
	private static DataStructureConverterFactory identity() {
		return singleton(IdentityConverter::new);
	}

	private static DataStructureConverterFactory singleton(Supplier<DataStructureConverter<?, ?>> supplier) {
