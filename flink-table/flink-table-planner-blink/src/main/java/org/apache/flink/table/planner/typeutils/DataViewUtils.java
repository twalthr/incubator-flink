...
public final class DataViewUtils {
	...
	/**
	 * Adapts the data type of an accumulator regarding data views and sets them to NULL.
	 */
	public static DataType adaptDataViewsInDataType(DataType accumulatorDataType) {
