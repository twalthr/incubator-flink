...
public class ValuesITCase extends AbstractTestBase {
	...
	public void testTypeConversions() throws Exception {
		...
		List<String> expected = Arrays.asList(
			"+I(0, D, 2000-12-12 12:30:57.123, +I(0, D, [1, 2, 3]))",
			"+I(1, ABC, 2000-12-12 12:30:57.12, +I(1, ABC, [1, 2, 3]))",
			"+I(3.0999999046325684, DEF, 2000-12-12 12:30:57.123, +I(3.0999999046325684, DEF, [1.0, 2.0, 3.0]))",
			"+I(3.141592653589793, ABC, 2000-12-12 12:30:57.123, +I(3.141592653589793, ABC, [1, 2, 3]))",
			"+I(99, DEFG, 2000-12-12 12:30:57.123, +I(99, DEFG, [1.0, 2.0, 3.0]))"
		);
