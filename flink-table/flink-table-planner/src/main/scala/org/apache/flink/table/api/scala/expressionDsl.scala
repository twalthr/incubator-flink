...
trait ImplicitExpressionOperations {
  ...
  /**
    ...
    */
  def toDate: Expression = call(CAST, expr, typeLiteral(fromLegacyInfoToDataType(SqlTimeTypeInfo.DATE)))

  /**
    * Parses a time string in the form "HH:mm:ss" to a SQL Time.
    */
  def toTime: Expression = call(CAST, expr, typeLiteral(fromLegacyInfoToDataType(SqlTimeTypeInfo.TIME)))
