...
class FlinkSerializationProvider extends DefaultSerializerProvider {
    ...
    FlinkSerializationProvider(DefaultSerializerProvider src, SerdeContext serdeContext) {
        super(src);
        this.serdeContext = serdeContext;
    }

    private FlinkSerializationProvider(
            FlinkSerializationProvider src,
            SerializationConfig serializationConfig,
            SerializerFactory serializerFactory) {
        super(src, serializationConfig, serializerFactory);
        this.serdeContext = src.serdeContext;
    }

    SerdeContext getSerdeContext() {
        return serdeContext;
    }

    @Override
    public DefaultSerializerProvider createInstance(
            SerializationConfig serializationConfig, SerializerFactory serializerFactory) {
        return new FlinkSerializationProvider(this, serializationConfig, serializerFactory);
    }
}
